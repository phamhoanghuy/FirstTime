...
<footer id="footer">
    ...
    <div class="container">
        <div class="info col-md-4 col-lg-4 col-xs-4">
        ...
        <div class="menu col-md-2 col-lg-2 col-xs-2">
            <br>
            <p><b>THÔNG TIN</b></p>
            <br>
            <ul>
